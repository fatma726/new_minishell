...
# Source files
MAIN   = env_utils env_helpers env_helpers_oldpwd signal_utils exit_file runtime runtime_flags \
         input line_reader line_reader_core line_reader_helpers input_helpers main process_command \
...
CMD    = cmd_cd cmd_cd_helpers cmd_cd_utils basic_commands cmd_utils env cmd_exec cmd_exec_helpers \
         cmd_exec_proc cmd_exec_error cmd_exec_error_helpers cmd_exec_error_helpers2 cmd_exec_error_format cmd_exec_error_format_helpers cmd_exit cmd_exit_ctx cmd_exit_helpers cmd_exit_helpers_more cmd_exec_helpers_more2 cmd_exit_utils cmd_exit_parse cmd_exit_parse_helpers \
...
PARSER = escape_split parser_utils parser_helpers parser_helpers2 parser \
         ...
         parser_spacing_redir parser_spacing_semicolons parser_expand_scan parser_expand_helpers2 parser_segments \
         parser_quotes_expand parser_quotes_core parser_quotes_helpers parser_quotes_utils \
         syntax_utils syntax_helpers_utils syntax_length_helpers syntax_length_helpers2 syntax syntax_helpers3 \
         syntax_helpers4 syntax_helpers5
...
PIPE   = pipe_core pipe_core_utils pipe_core_extras pipe_utils pipe_utils2 pipe_helpers pipe_helpers_more
